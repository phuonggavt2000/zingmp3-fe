...
function LeftSidebar() {
    return (
        ...
        >
            ...
            <div className="relative overflow-hidden hover:overflow-y-auto pt-5 after:block after:absolute after:h-[1px] after:w-3/4 after:bg-skin after:top-0 after:right-1/2 after:translate-x-2/4">
            ...
            <div className=" w-full mt-auto p-4 flex items-center justify-center text-[15px] font-semibold border-t border-skin ">
